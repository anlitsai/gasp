...
file_log='gasp_target_fitsheader_info_exclude_baddata_'+yearmonth+'.log'
#file_log='gasp_target_fitsheader_info_exclude_baddata_202002.log'
...
#cmd_search_file_sci2="find ./2020[0-1][0-9] |grep 'fits\|fts\|new'|grep calib_sci |sort "
