...
for i in range(n_data):
    ...
    w1_file='all_annu_iau.txt'
#    df_w1=pd.read_csv(w1_file,delim_whitespace=True,header=None,usecols=[0,1,2]) 
    df_w1=pd.read_csv(w1_file,sep="|",usecols=[2,5,13,19,23,24]) 
#    print(df_w1)
    df_w1=df_w1[]
...
plt.savefig('dat_plot_all_annu.pdf') 

print("... save file as dat_plot_all_annu.pdf ...")
