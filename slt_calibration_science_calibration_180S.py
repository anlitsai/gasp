...
'''
'''
print('...move ./'+dir_calib_sci+' to ./'+yearmonth+'/ ...')
if os.path.exists(yearmonth+'/'+dir_calib_sci):
    shutil.rmtree(yearmonth+'/'+dir_calib_sci)
cmd_mv_dir='mv ./'+dir_calib_sci+' ./'+yearmonth+'/'
