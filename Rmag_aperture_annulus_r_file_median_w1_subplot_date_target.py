...
file_info='gasp_target_fitsheader_info_exclude_baddata_join.txt'
#file_info='gasp_target_fitsheader_info_exclude_baddata_'+date1+'-'+date2+'.txt'
#file_info='gasp_target_fitsheader_info_exclude_baddata_201911-.txt'
#file_info='gasp_target_fitsheader_info_exclude_baddata_201911-201912.txt'
...
#ID_selected=np.array([2043,2044,2059,2060])  #AO0235+16
#ID_selected=np.array([2043,2044])  #AO0235+16
...
'''
df_Rmag_keep=df_out_keep[['JD','Rmag','ErrorRmag']].astype(float) #.reset_index(drop=True)
#df_Rmag_keep=df_out_keep[['JD','Rmag','ErrorRmag']].reset_index(drop=True)
#df_Rmag_keep['JD']=df_Rmag_keep['JD'].map('{:.4f}'.format)
df_Rmag_keep['Observatory']='Lulin (SLT)'

print(df_Rmag_keep)

#file_Rmag_out_keep=dir_obj+'Rmag_'+obj_name+'.txt'
file_Rmag_out_keep=dir_obj+'g'+iau_name_short+'r_LuS_'+191126+'.dat'
#df_Rmag_keep.to_csv(file_Rmag_out_keep,sep=',',index=False,float_format='%.5f')
#df_Rmag_keep.to_csv(file_Rmag_out_keep,sep='\t',index=False,float_format='%.5f')
#with open(file_Rmag_out_keep,'w') as f: file_Rmag_out_keep.to_string(f,col_space=3)
df_Rmag_keep.to_csv(file_Rmag_out_keep,sep='\t',index=False,float_format=['%.5f','%.3f','%.3f'],header=None)
'''
